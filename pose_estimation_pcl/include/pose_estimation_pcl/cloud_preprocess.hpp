...
public:
    ...
    PointCloudPreprocess(
        ...
        const Config& config);
        // std::shared_ptr<PlaneSegmentation> plane_segmenter = nullptr,
        // std::shared_ptr<CloudClustering> cloud_clusterer = nullptr);
...
private:
    ...
    // std::shared_ptr<PlaneSegmentation> plane_segmenter_;
